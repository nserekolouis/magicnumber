...
<div class="main">
  <div class="form">
    <form id="myform">
      <label>Pay Airtel(Initiate)</label></br>
      <input type="tel" name="contact" id="contact" placeholder="07..." required></br>
      <input type="number" name="code" id="code" placeholder="Secret code" required></br>
      <input type="number" name="amount" id="amount" placeholder="0.0"></br>
      <input type="text" name="network" id="network" value="Airtel" hidden></br>
    ...
    <form id="myform">
      ...
      <center>
          ...
          <div class="modal-body">
            <div id ="ring" class="lds-dual-ring">
            </div>
          </div>
